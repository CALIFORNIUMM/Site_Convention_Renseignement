...
('BERTRAND','Loïc','0682778747','$2y$10$jaa7NnbdBhEuL5hMLGMbteg.KXzsep5/VCVs.Ql9DZj/SYZ45jHdG', '2002-06-12','Toulouse',NULL,NULL,NULL,'2020-09-03', 'lb'),
('BONNET','Gwénaël','0604161969','$2y$10$jaa7NnbdBhEuL5hMLGMbteg.KXzsep5/VCVs.Ql9DZj/SYZ45jHdG', '2002-10-15','Toulouse',NULL,NULL,NULL,'2020-09-03', 'gb'),
...
('OLIVIER','Lucile','0781538442','$2y$10$jaa7NnbdBhEuL5hMLGMbteg.KXzsep5/VCVs.Ql9DZj/SYZ45jHdG', '2002-08-12','Toulouse',NULL,NULL,NULL,'2020-09-03', 'ol'),
...
('ZANCHI','Thomas','0783193074','$2y$10$jaa7NnbdBhEuL5hMLGMbteg.KXzsep5/VCVs.Ql9DZj/SYZ45jHdG', '2002-04-17','Toulouse',NULL,NULL,NULL,'2020-09-03', 'ct'),
('ZAYAT','Stéphane','0669624480','$2y$10$jaa7NnbdBhEuL5hMLGMbteg.KXzsep5/VCVs.Ql9DZj/SYZ45jHdG', '2002-10-25','Toulouse',NULL,NULL,NULL,'2020-09-03', 'ct');
...
('9','OFFICE NOTARIAL DE MAITRE PAMBO', NULL, '51', 'Avenue de Toulouse', '31240', 'L Union', NULL, NULL, NULL),
...
('19','CS GROUP', NULL, '5', 'rue Brindejonc des Moulinais Parc de la Grande Plaine', '31506', 'Toulouse', NULL, NULL, NULL),
('20','EXM COMPAGNY', NULL, '116', 'Route d Espagne BAL 513 - HELIOS 7', '31100', 'Toulouse', NULL, NULL, NULL),
('21','INP ENSIACET', NULL, '4', 'rue Emile Monso', '31030', 'Toulouse', NULL, NULL, NULL),
('22','DODIN CAMPENON BERNARD', NULL, '20', 'Chemin de la Flambère', '31026', 'Toulouse', NULL, NULL, NULL),
('23','ECOLE NATIONALE DE L AVIATION CIVILE', NULL, '7', 'avenue Edouard Belin BP 54005', '31055', 'Toulouse', NULL, NULL, NULL),
('24','LRSV-UMR5546', NULL, '24', 'chemin de Borde Rouge', '31326', 'Castanet', NULL, NULL, NULL),
('25','ENSEMBLE SCOLAIRE ST JOSEPH LA SALLE', NULL, '85', 'Rue de Limayrac', '31079', 'Toulouse', NULL, NULL, NULL);
...
INSERT INTO `contact` (`nomContact`, `prenomContact`, `telContact`, `mailContact`, `fct_contact`, `is_gerant`, `idEnt`) VALUES 
('Tamallah', 'Sabrina', '0622674467', 'sabrina@humanupconsulting.fr', 'Gérante', 'Oui', '1'),
('De Cruzel', 'Gilles', NULL, 'gillesdecruzel@horus-solutions.org', 'CTO', 'Non', '2'),
('Veitmann', 'Jonathan', '0383595234', 'joveitmann@mgen.fr', 'Responsable de service', 'Non', '3'),
('Bizoh', 'Remi', '0468270335', 'remi.bizot@ccrlcm.fr', 'Chargé(e) de communication', 'Non', '4'),
('Marre', 'Edith', '0563402001', 'edith.marre@ac-toulouse.fr', 'Chef d Etablissement du Collège', 'Oui', '5'),
('Chamayou', NULL, '0561717230', 'm.chamayou@mairie-blagnac.fr', 'DSI', 'Non', '6'),
('Baudet', 'Denis', '0561285385', 'denis.baudet@inrae.fr', 'Informaticien', 'Non', '7'),
('Delaville', 'Thibault', '0562662806', 'thibault.delaville@tiria.fr', 'Développeur', 'Non', '8'),
('Monducci', 'Nicolas', '0628255460', NULL, 'Professeur de Technologie', 'Non', '5'),
('Porta', NULL, NULL, 'PORTA@SAINTJOSEPHTOULOUSE.ORG', 'Responsable Moyens Généraux', 'Non', '25'),
